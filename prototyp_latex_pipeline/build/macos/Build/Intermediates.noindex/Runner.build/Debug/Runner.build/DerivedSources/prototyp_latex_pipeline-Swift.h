...
#ifndef PROTOTYP_LATEX_PIPELINE_SWIFT_H
#define PROTOTYP_LATEX_PIPELINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="prototyp_latex_pipeline",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC23prototyp_latex_pipeline11AppDelegate")
...
SWIFT_CLASS("_TtC23prototyp_latex_pipeline17MainFlutterWindow")
